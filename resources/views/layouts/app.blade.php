...
<body onload="navActive()">
    ...
    function EnrollEmployeeKardex() {
            ...
            Swal.fire({
                title: '¿Estás seguro?',
                text: '¿Inscribir empleado ' + empid + ' con dedo ' + dedo + ' en el dispositivo ' + lector + '?',
                icon: 'warning',
                showCancelButton: true,
                confirmButtonText: '¡Sí, inscribir!',
                cancelButtonText: 'No, cancelar'
    ...
    <script>
        ...
        function OpenEnrollEmployeeModal() {
            ...
            document.getElementById('send').checked = false;
            document.querySelector('#enrollModal .modal-title').textContent = "Enrolar empleado | " + currentEmployee.substring(1, 10);
            var modal = new bootstrap.Modal(document.getElementById('enrollModal'), {});
            modal.show();
